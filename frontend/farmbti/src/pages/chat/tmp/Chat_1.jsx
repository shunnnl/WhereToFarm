...
const handleLeaveRoom = async () => {
  ...
  try {
    ...
    console.log(`채팅방 ${roomId} 나가기 요청 시작`);
    
    // 인터셉터가 자동으로 헤더를 추가하도록 하기 위해 추가 헤더 없이 요청
    const response = await authAxios.delete(`/chat/delete/${roomId}`);
    ...
    // 사용자에게 오류 메시지 표시
    alert(`채팅방 나가기에 실패했습니다: ${error.message || '다시 시도해주세요'}`);
  }
};
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <button 
                  ...
                  className="text-red-500 hover:text-red-700 px-3 py-1 rounded border border-red-500 hover:bg-red-50 transition-colors text-sm"
                >
                  채팅방 나가기
                </button>
