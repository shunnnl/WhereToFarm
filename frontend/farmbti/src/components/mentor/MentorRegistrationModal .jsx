  ...
  const topFood = [
    {
      ...
      label: "사과",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/apple.png",
    },
    {
      id: "오이",
      label: "오이",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/cucumber.png",
    },
    {
      id: "포도",
      label: "포도",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/grape.png",
    },
    {
      id: "대파",
      label: "대파",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/greenonion.png",
    },
    {
      id: "상추",
      label: "상추",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/lettuce.png",
    },
    {
      id: "양파",
      label: "양파",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/onion.png",
    },
    {
      id: "배",
      label: "배",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/pear.png",
    },
    {
      id: "고구마",
      label: "고구마",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/sweetpotato.png",
    },
    {
      id: "감귤",
      label: "감귤",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/tangerine.png",
    },
    {
      id: "수박",
      label: "수박",
      iconSrc:
        "https://farmbticropbuckets.s3.ap-northeast-2.amazonaws.com/watermelon.png",
    },
  ];
      ...
      <form onSubmit={handleSubmit} className="w-full">
        <div className="mb-4 text-center w-full">
          ...
          <p className="text-gray-600 text-sm">
            성공적인 자신의 귀농 스토리를 들려주고 싶지 않나요?
          </p>
          <p className="text-gray-600 text-sm">
            멘토로 등록한 후, 멘티들과 많은 이야기를 나누어보세요!
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start space-x-4">
            <h3 className="text-lg font-bold whitespace-nowrap mt-2">
              재배 작물
            </h3>
            <div className="flex flex-wrap justify-center">
              {topFood.map((food) => (
                <div
                  key={food.id}
                  className="w-1/5 p-1 flex flex-col items-center"
                >
        ...
        {submitResult && (
          <div
            ...
            } px-4 py-2 rounded mt-3 mb-2 border`}
          >
